...
<head>
    ...
    <title>Latihan Soal TKA: Pemahaman Kosakata (15 Soal)</title>
...
<body class="min-h-screen">
    ...
    <script>
        // [DIUBAH] Soal ditambah menjadi 15
        const questions = [
            ...
            { 
                type: 'mcq', 
                level: 1, 
                question: "Kata 'sedih' memiliki lawan kata (antonim) ...", 
                indicator: "Mengidentifikasi antonim (lawan kata) sederhana.",
                options: ["Gembira", "Marah", "Takut", "Lapar"],
                answer: "Gembira",
                explanation: "**Sedih** adalah perasaan tidak senang. Lawan katanya adalah **gembira**, yang berarti perasaan sangat senang."
            },
            ...
            { 
                type: 'mcq', 
                level: 2, 
                question: "Ibu *menggoreng* ikan di wajan dengan minyak panas.\n\nKata 'menggoreng' berarti...", 
                indicator: "Menentukan makna kata kerja (verba) berdasarkan konteks kalimat.",
                options: [
                    "Memasak dengan cara merebus di air", 
                    "Memasak dengan cara memanggang di oven", 
                    "Memasak dengan cara mengukus di uap", 
                    "Memasak dengan cara mencelupkan ke minyak panas"
                ],
                answer: "Memasak dengan cara mencelupkan ke minyak panas",
                explanation: "**Menggoreng** adalah proses memasak makanan menggunakan minyak panas di wajan atau penggorengan. Merebus menggunakan air, memanggang menggunakan oven, dan mengukus menggunakan uap panas."
            },
            ...
            { 
                type: 'mcq', 
                level: 3, 
                question: "Rian dijuluki *kutu buku* oleh temannya karena ia sangat rajin membaca.\n\nApa arti ungkapan (idiom) 'kutu buku'?", 
                indicator: "Memahami makna kata kiasan (ungkapan) sederhana.",
                options: [
                    "Orang yang suka mengoleksi serangga", 
                    "Orang yang sangat suka membaca buku", 
                    "Orang yang bukunya kotor", 
                    "Orang yang jahat seperti kutu"
                ],
                answer: "Orang yang sangat suka membaca buku",
                explanation: "**'Kutu buku'** adalah sebuah ungkapan (idiom) untuk menggambarkan seseorang yang menghabiskan banyak waktunya untuk membaca buku. Ini adalah makna kiasan, bukan makna sebenarnya."
            },
            ...
            { 
                type: 'mcq', 
                level: 4, 
                question: "Kalimat: 'Para *pahlawan* telah berjuang *bermati-matian* demi kemerdekaan.'\n\nKata 'bermati-matian' digunakan untuk menunjukkan bahwa perjuangan pahlawan...?", 
                indicator: "Menganalisis makna tersirat dari sebuah kata (hiperbola).",
                options: [
                    "Dilakukan dengan main-main", 
                    "Dilakukan dengan penuh kesungguhan dan pengorbanan", 
                    "Dilakukan tanpa alasan yang jelas", 
                    "Dilakukan karena terpaksa"
                ],
                answer: "Dilakukan dengan penuh kesungguhan dan pengorbanan",
                explanation: "Kata **'bermati-matian'** adalah gaya bahasa hiperbola (melebih-lebihkan) untuk menekankan bahwa perjuangan itu sangat berat, sungguh-sungguh, dan rela mengorbankan nyawa."
            },
            ...
            { 
                ...
                indicator: "Membedakan fakta dan opini berdasarkan pilihan kata.",
                statements: [
                    { text: "Kata 'terindah' dalam kalimat 'Itu pemandangan terindah' adalah sebuah opini.", answer: true },
                    { text: "Kata 'mendidih' dalam kalimat 'Air mendidih pada 100°C' adalah sebuah fakta.", answer: true },
                    { text: "Kata 'lezat' dalam kalimat 'Masakan ini lezat' adalah sebuah fakta.", answer: false }
                ],
                explanation: "Fakta bisa diukur (mendidih pada 100°C). Opini adalah pendapat subjektif (terindah, lezat). Jadi, pernyataan 'kata lezat adalah sebuah fakta' adalah **Salah**, karena 'lezat' adalah opini."
            }
        ];
        ...
        const updateScore = () => {
            ...
            if (scoreChart) {
                ...
                // [DIUBAH] Update max value untuk bar chart
                scoreChart.options.scales.y.max = questions.length;
                scoreChart.update();
            }
        };

        // [DIUBAH] Fungsi initChart() diganti menjadi Bar Chart
        const initChart = () => {
            ...
            scoreChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Soal',
                        data: [0, 0, questions.length], // Data awal
                ...
                options: {
                    ...
                    plugins: {
                        legend: { 
                            display: false // Legenda disembunyikan
                        },
                        tooltip: { 
                            enabled: true 
                        }
                    ...
                    scales: {
                        y: {
                            beginAtZero: true,
                            max: questions.length, // Max value dinamis
                            ticks: {
