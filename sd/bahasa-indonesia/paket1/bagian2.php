...
$page_title = 'Kuis Kosakata Teks Fiksi dan Nonfiksi';
$page_description = 'Latihan soal untuk menguji pemahaman tentang kosakata dalam teks fiksi dan nonfiksi.';
...
$questions = [
    [
        'question' => 'Dalam sebuah cerita fantasi, penulis menggambarkan sebuah "naga" yang bisa terbang. Kata "naga" dalam konteks ini adalah contoh kosakata dalam teks...',
        'options' => [
            'a' => 'Fiksi',
            'b' => 'Nonfiksi',
            'c' => 'Biografi',
    ...
    [
        'question' => 'Sebuah artikel berita tentang pemanasan global menggunakan kata "emisi karbon". Kata tersebut adalah contoh kosakata dalam teks...',
        'options' => [
            'a' => 'Fiksi',
            'b' => 'Nonfiksi',
            'c' => 'Puisi',
...
<main class="py-20">
    <div class="container mx-auto p-4 sm:p-6 lg:p-8 max-w-7xl">
        <header class="text-center mb-8">
            <h1 class="text-3xl sm:text-4xl font-bold text-[#4A4A4A] mb-2">Latihan Soal TKA: Kosakata Teks Fiksi dan Nonfiksi</h1>
