...
$page_title = 'Kuis Informasi dari Teks dalam Bentuk Ikhtisar/Bagan';
$page_description = 'Latihan soal untuk menyajikan informasi dari teks dalam bentuk ikhtisar atau bagan.';
...
"Rantai makanan adalah peristiwa makan dan dimakan antara sesama makhluk hidup dengan urutan-urutan tertentu. Dalam rantai makanan, terdapat makhluk hidup yang mempunyai peran sebagai produsen, konsumen, dan sebagai dekomposer."
Manakah bagan yang paling tepat untuk menggambarkan rantai makanan?',
        'options' => [
            'a' => 'Produsen -> Konsumen -> Dekomposer',
            'b' => 'Konsumen -> Produsen -> Dekomposer',
            'c' => 'Dekomposer -> Produsen -> Konsumen',
            'd' => 'Produsen -> Dekomposer -> Konsumen'
        ],
        'answer' => 'a'
    ],
    [
        'question' => 'Ikhtisar yang paling tepat untuk teks di atas adalah...', 
        'options' => [
            'a' => 'Rantai makanan adalah urutan makan dan dimakan dengan peran produsen, konsumen, dan dekomposer.',
            'b' => 'Makhluk hidup terdiri dari produsen, konsumen, dan dekomposer.',
            'c' => 'Setiap makhluk hidup akan dimakan.',
            'd' => 'Produsen adalah awal dari rantai makanan.'
        ],
        'answer' => 'a'
    ]
];
...
<main class="py-20">
    <div class="container mx-auto p-4 sm:p-6 lg:p-8 max-w-7xl">
        <header class="text-center mb-8">
            <h1 class="text-3xl sm:text-4xl font-bold text-[#4A4A4A] mb-2">Latihan Soal TKA: Informasi dari Teks dalam Bentuk Ikhtisar/Bagan</h1>
