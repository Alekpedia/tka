<?php 
    ...
    $page_title = 'Latihan Soal TKA Bahasa Indonesia SD / MI';
    $page_description = 'Pilih paket soal latihan TKA Bahasa Indonesia SD/MI yang ingin kamu kerjakan di bawah ini.';
    ...
    <section id="latihan-mat-sd" class="py-20 bg-slate-50">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <a href="bahasa-indonesia-paket-1" class="group block bg-white rounded-2xl p-6 shadow-lg border border-slate-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20" data-aos="fade-up" data-aos-delay="100">
