   ...
   <section id="latihan-smp" class="py-20 bg-slate-50">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto">
                ...
                <a href="#" class="w-full md:w-[calc(33.333%-1rem)] group block bg-white rounded-2xl p-6 shadow-lg border border-slate-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-green-500/20" data-aos="fade-up" data-aos-delay="250">
                    <div class="flex items-start space-x-4">
                ...
                <a href="#" class="w-full md:w-[calc(33.333%-1rem)] group block bg-white rounded-2xl p-6 shadow-lg border border-slate-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-500/20" data-aos="fade-up" data-aos-delay="300">
                    <div class="flex items-start space-x-4">
