<?php 
    ...
    $page_title = 'Latihan Soal TKA Bahasa Inggris SMA/SMK/MA';
    $page_description = 'Pilih paket soal latihan TKA Bahasa Inggris SMA/SMK/MA yang ingin kamu kerjakan di bawah ini.';
