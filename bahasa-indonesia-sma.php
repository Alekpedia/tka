<?php 
    ...
    $page_title = 'Latihan Soal TKA Bahasa Indonesia SMA/SMK/MA';
    $page_description = 'Pilih paket soal latihan TKA Bahasa Indonesia SMA/SMK/MA yang ingin kamu kerjakan di bawah ini.';
